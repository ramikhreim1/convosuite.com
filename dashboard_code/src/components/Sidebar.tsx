...
import Logo from '../images/logo/flowise_logo.png';
import SidebarLinkGroup from './SidebarLinkGroup';
import ProfileCardMini from './ProfileCardMini';
import { CgFileDocument } from "react-icons/cg"
import { BsChatRightText } from 'react-icons/bs';
import { AiFillAppstore, AiOutlineFileImage } from 'react-icons/ai';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark   ${sidebarOpen
    ...
    >
      ...
      {/* <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <div className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ">
            Email: admin@chatgp.se
          </div>
          <div className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ">
            Role:   Admin
          </div>
          <div className="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out">
            <button className='py-1 px-2 bg-blue-100 rounded' style={{backgroundColor:"#2346d4e6"}}>Resend Password</button>
            <button className='py-1 px-2 bg-blue-800 rounded' style={{backgroundColor:"#2346d4e6"}}>Edit Profile</button>
          </div>
        </div>
      </div> */}
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/brains"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname === "/brains" &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <BiSolidDashboard />
              ...
              <li>
                <a
                  href="https://studio.convosuite.com"
                  target='_blank'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${false &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <AiFillAppstore />
              ...
              <li>
                <a
                  href="https://docs.convosuite.com"
                  target='_blank'
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${false &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
      ...
      <div className='flex items-end flex-1 mt-5 py-4 px-4 lg:mt-9 lg:px-6'>
        <hr className="h-1 my-2 bg-gray-200 dark:bg-gray-700"></hr>
        <ProfileCardMini />
      </div>
    </aside>
  );
