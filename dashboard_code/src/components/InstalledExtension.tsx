const InstalledExtension = () => {
  return (
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      {/* <div className="m-1 w-auto rounded border border-stroke bg-bodydark py-6 px-7 my-4 text-sm shadow-default dark:border-strokedark dark:bg-[#1a222c]">
        Installed
       ...
       <div className="flex my-4 h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-[#1a222c]">
        <svg
