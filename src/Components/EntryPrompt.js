...
class EntryPrompt extends Component {
	render() {
		...
		return (
			<div className={`align-bottom bg-white md:rounded-md text-left transform transition-all sm:align-middle transition hover:shadow-md shadow-2xl focus:shadow-2xl md:mb-8  ${hidden ? "hidden" : ""}`}>
